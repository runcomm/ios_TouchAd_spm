...
+ (void)openEarningMenu:(NSString * _Nonnull)cid;
+ (void)openAdvertise:(NSString * _Nonnull)cid userInfoString:(NSString * _Nonnull)userInfoString;
+ (void)openApprlNoMenu:(NSString * _Nonnull)cid;
